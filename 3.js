...
class TeaMaker {
  // Робимо метод prepareTea, який викликає всі кроки приготування чаю по черзі boilWater, addTeaLeaves, #steepTea,
  // pourIntoCup, addCondiments, serveTea.

  prepareTea() {
    this.boilWater();
    this.addTeaLeaves();
    this.steepTea(), this.pourIntoCup();
    this.addCondiments();
    this.serveTea();
  }
...
class BlackTeaMaker extends TeaMaker {
  // Робимо метод addCondiments, який виводить в консоль Додаємо молоко та цукор, щоб приготувати чорний чай...
  addCondiments() {
